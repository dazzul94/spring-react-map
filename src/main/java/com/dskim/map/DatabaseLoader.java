...
public class DatabaseLoader implements CommandLineRunner {
	...
	public void run(String... strings) throws Exception {
		...
		this.searchHistories.save(new SearchHistory("카페베네", admin));
		this.searchHistories.save(new SearchHistory("스타벅스", admin));
		this.searchHistories.save(new SearchHistory("할리스", admin));
		
		this.searchHistories.save(new SearchHistory("롯데리아", admin2));
		this.searchHistories.save(new SearchHistory("맥도날드", admin2));
		this.searchHistories.save(new SearchHistory("버거킹", admin2));
